...
st.markdown("<h1 style='color: purple;'>📚DataBase Project Phase II</h1>", unsafe_allow_html=True)

st.markdown("<h3 style='color: green;'>✍️ Created by Sina Asghari, Fozhan Fahimzadeh and Shadmehr Salehi</h3>", unsafe_allow_html=True)
